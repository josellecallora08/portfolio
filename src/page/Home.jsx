...
const Home = () => {
  ...
  return (
    <div className={`w-full h-screen grid self-center`}>
       <div className={`relative w-full h-full flex flex-col rounded-md shadow-xl bg-slate-200/50 md:bg-slate-200/70 m-auto md:flex-col md:w-4/5 md:h-4/5 dark:bg-black/80 ${awardsModal || aboutModal || educationModal || projectModal || workModal ? 'fade-out' : 'md:flex open'} overflow-hidden`}>
