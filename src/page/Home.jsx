...
const Home = () => {
  ...
  return (
    <div className={`w-full h-screen grid self-center`}>
       <div className={`relative w-screen h-screen grid rounded-md shadow-xl bg-slate-200/50 m-auto md:flex-col md:w-4/5 md:h-4/5 dark:bg-black/80 open-card ${awardsModal || aboutModal || educationModal || projectModal || workModal ? 'duration-500 hidden' : 'md:flex open'}`}>
