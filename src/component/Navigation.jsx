...
import d_blog from '/blog-dark-icon.svg'


const Navigation = ({is_theme_dark,setAboutModal, setAwardsModal, setEducationModal, setProjectModal, setWorkModal, setBlogModal}) => {
    ...
    <div className='w-full h-3/6 md:h-full flex items-center left-transition md:bg-green-800/20 dark:text-slate-300'>
        <div className='w-full md:w-4/5 h-4/5 flex items-center py-5 m-auto font-mono text-xs md:text-lg'>
            <ul className='flex m-auto items-center gap-2 flex-wrap cursor-pointer'>
                ...
                <li className='flex items-center gap-2 p-2 px-5 border md:border-0 w-fit flex-wrap rounded-md hover:bg-slate-100/30' onClick={() => value.modal(prevState => !prevState)}>
