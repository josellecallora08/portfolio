...
const Education = ({educationModal, setEducationModal, is_theme_dark}) => {
  ...
  return (
    <div className={`fixed flex justify-center items-center w-full h-full z-10 md:opacity-0 ${educationModal ? 'md:opacity-100 duration-500' : '' }`}>
      <div className={`relative w-screen h-screen md:w-3/5 md:h-4/5 m-auto rounded-md bg-slate-300 md:bg-slate-200 dark:bg-black duration-500 shadow-xl `} >
       ...
       <figure className='flex flex-col items-center gap-5 font-mono font-semi-bold '>
          ...
          <figcaption className='w-full dark:text-slate-300'>
            <a href="https://www.tup.edu.ph" target='_blank' className='text-xl font-bold xl:text-4xl tracking-wider uppercase cursor-pointer hover:underline'>Technological University of the Philippines</a>
            <p>Bachelor of Science in Information Systems (September 2020 - Current)</p>
            <p>Manila</p>
          </figcaption>
        </figure>
        <figure className='flex flex-col items-center gap-5 font-mono font-semi-bold '>
          ...
          <figcaption className='w-full dark:text-slate-300'>
            <a href="https://www.stjude.edu.ph" target='_blank' className='text-xl font-bold xl:text-4xl tracking-wider uppercase hover:underline'>St. Jude College of Dasmariñas city Cavite</a>
        ...
        <figure className='flex flex-col w-full items-center gap-5 font-mono  font-semi-bold '>
          ...
          <figcaption className='w-full dark:text-slate-300'>
            <a href="https://apecschools.edu.ph" target='_blank' className='text-xl font-bold xl:text-4xl tracking-widest uppercase hover:underline' >APEC Schools</a>
