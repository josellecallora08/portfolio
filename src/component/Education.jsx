...
const Education = ({educationModal, setEducationModal, is_theme_dark}) => {
  ...
  return (
    <div className={`absolute w-full h-full ${educationModal ? 'open' : 'hidden fade-out'} justify-center items-center md:py-10`}>
      <div className={`relative w-full h-auto md:w-3/5 m-auto bg-slate-300 rounded-md md:bg-slate-200 dark:bg-black shadow-xl overflow-hidden`}>
       ...
       <figure className='flex flex-col w-full items-center gap-5 font-mono font-semi-bold '>
          ...
          <figcaption className='w-full dark:text-slate-300'>
            ...
            <p className='text-xs md:text-base mt-5 open'>
