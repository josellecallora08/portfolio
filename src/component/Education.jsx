...
const Education = ({educationModal, setEducationModal, is_theme_dark}) => {
  ...
  return (
    <section id="education" className={`fixed w-full h-full ${educationModal ? 'flex open' : 'fade-out hidden'} justify-center items-center`}>
      <div className={`relative w-full h-auto md:h-4/5  md:w-3/5 m-auto bg-slate-200/50 rounded-md md:bg-slate-200/70 dark:bg-black/50 shadow-xl overflow-hidden`}>
