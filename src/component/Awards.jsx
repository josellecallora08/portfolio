...
const Awards = ({awardsModal, setAwardsModal, is_theme_dark}) => {
  return (
    <section id="award" className={`${awardsModal ? 'open' : 'hidden fade-out'} justify-center items-center w-full h-full`}>
      <div className={`relative w-full h-full md:w-3/5 m-auto bg-slate-200/50 rounded-md md:bg-slate-200/70 dark:bg-black/50 shadow-xl backdrop-blur-sm overflow-hidden`}>
