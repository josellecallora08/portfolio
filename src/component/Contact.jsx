...
import resume_icon from '/resume-icon.svg'
...
const Contact = ({is_theme_dark}) => {
  return (
    <article className='w-full md:w-4/5 h-4/5 m-auto'>
        <h2 className='relative w-fit md:text-3xl uppercase font-semibold font-mono group cursor-default dark:text-slate-300'>Connect With Me 
